...
./configure "--prefix=${basedir}/build/${mode}/${processor}/installdir" --without-gnu-ld --disable-doxygen --disable-dot --disable-latex-docs --disable-static --host=i686-pc-mingw32 --build=x86_64-pc-linux
make && make install
errorcode=$?
