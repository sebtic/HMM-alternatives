...
/**
 * A dependency checker for the compiler.
 * 
 * @author Sébastien Aupetit
 */
public final class Compiler extends AbstractDependencyChecker {

  /**
   * Check if the compiler properties are compatible.
   * 
   * @param token
  ...
  public boolean checkAParameterForSource(final String token, final Properties sourceProperties,
    ...
    return strictCheckOnly(token, sourceProperties, dependsOnProperties, "alternatives.Compiler");
  }
