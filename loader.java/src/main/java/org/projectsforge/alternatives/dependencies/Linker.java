...
/**
 * A dependency checker for the linker.
 * 
 * @author Sébastien Aupetit
 */
public final class Linker extends AbstractDependencyChecker {

  /**
   * Check if the linker properties are compatible.
   * 
   * @param token
  ...
  public boolean checkAParameterForSource(final String token, final Properties sourceProperties,
    ...
    return strictCheckOnly(token, sourceProperties, dependsOnProperties, "alternatives.Linker");
  }
