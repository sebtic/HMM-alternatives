...
/**
 * A dependency checker for the Mode (Debug/Release).
 * 
 * @author Sébastien Aupetit
 */
public final class Mode extends AbstractDependencyChecker {

  /**
   * Check if the Mode properties are compatible.
   * 
   * @param token
  ...
  public boolean checkAParameterForSource(final String token, final Properties sourceProperties,
    ...
    return strictCheckOnly(token, sourceProperties, dependsOnProperties, "alternatives.Mode");
  }
