...
/**
 * A dependency checker for the OS.
 * 
 * @author Sébastien Aupetit
 */
public final class Os extends AbstractDependencyChecker {

  /**
   * Check if the OS properties are compatible.
   * 
   * @param token
  ...
  public boolean checkAParameterForSource(final String token, final Properties sourceProperties,
    ...
    return strictCheckOnly(token, sourceProperties, dependsOnProperties, "alternatives.OS");
  }
