...
/**
 * A requirement checker for the architecture.
 * 
 * @author Sébastien Aupetit
 */
public class Arch extends AbstractRequirementChecker {

  /**
   * Check if the current architecture is compatible with the descriptor.
   * 
   * @param token
  ...
  public final boolean checkAParameter(final String token, final Properties properties) {
    return strictCheckOnly(token, properties, "alternatives.Arch", Utils.getCurrentArch());
  }
