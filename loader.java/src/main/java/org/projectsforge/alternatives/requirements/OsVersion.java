...
/**
 * A requirement checker for the OS version.
 * 
 * @author Sébastien Aupetit
 */
public class OsVersion extends AbstractRequirementChecker {

  /**
   * Check if the current OS version is compatible with the descriptor.
   * 
   * @param token
   ...
   */
  @Override
  public final boolean checkAParameter(final String token, final Properties properties) {
    return strictCheckOnly(token, properties, "alternatives.OSVersion", Utils.getCurrentOSVersion());
  }
   ...
   */
  @Override
  public final boolean isInstanceReusable() {
    return true;
  }
